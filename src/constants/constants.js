const WAITING_FOR_PLAYERS =
  'com.eleks.academy.whoami.core.state.impl.WaitingForPlayers';
const SUGGESTING_CHARACTERS =
  'com.eleks.academy.whoami.core.state.impl.SuggestingCharacters';
const PROCESSING_QUESTION =
  'com.eleks.academy.whoami.core.state.impl.ProcessingQuestion';
